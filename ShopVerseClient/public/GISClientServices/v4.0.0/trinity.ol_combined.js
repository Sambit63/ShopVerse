  ...
  var e = "ol-ctx-menu",
    ...
    c = {
      ...
      addClass: function(e, t, n) {
        ...
        for (var s = Array.isArray(t) ? t : t.split(/\s+/), o = s.length; o--;) i.hasClass(e, s[o]) || i._addClass(e, s[o], n)
      },
      _addClass: function(e, t, n) {
        var i = this;
        e.classList ? e.classList.add(t) : e.className = (e.className + " " + t).trim(), n && this.isNumeric(n) && window.setTimeout(function() {
          i._removeClass(e, t)
        }, n)
      },
      removeClass: function(e, t, n) {
        ...
        for (var s = Array.isArray(t) ? t : t.split(/\s+/), o = s.length; o--;) i.hasClass(e, s[o]) && i._removeClass(e, s[o], n)
      },
      _removeClass: function(e, t, n) {
        var i = this;
        e.classList ? e.classList.remove(t) : e.className = e.className.replace(this.classRegex(t), " ").trim(), n && this.isNumeric(n) && window.setTimeout(function() {
          i._addClass(e, t)
        }, n)
      },
      ...
      find: function(e, t, n) {
        ...
        if (i.test(e)) switch (e[0]) {
          case "#":
            ...
            break;
          case ".":
            a = o.call(t.getElementsByClassName(e.substr(1).replace(s, " ")));
            break;
          default:
            a = o.call(t.getElementsByTagName(e))
        } else a = o.call(t.querySelectorAll(e));
        return n ? a : a[0]
      },
      ...
      assertEqual: function(e, t, n) {
        if (e != t) throw new Error(n + " mismatch: " + e + " != " + t)
      },
      assert: function(e, t) {
    ...
    p = [{
      ...
      callback: function(e, t) {
        ...
        t.beforeRender(i, s), n.setCenter(e.coordinate), n.setZoom(+n.getZoom() + 1)
      }
    }, {
      text: "Zoom Out",
      classname: [e + r, e + o].join(" "),
      callback: function(e, t) {
        var n = t.getView(),
          i = ol.animation.pan({
            duration: 1e3,
    ...
    m = function(e) {
      return this.Base = e, this.map = void 0, this.coordinate_clicked = void 0, this.pixel_clicked = void 0, this.counter = 0, this.lineHeight = 0, this.items = {}, this.submenu = {
        left: this.Base.options.width - 15 + "px",
        last_left: ""
      }, this
    };
  m.prototype.init = function(e) {
    this.map = e, this.setListeners(), this.Base.constructor.Html.createMenu(), this.lineHeight = this.getItemsLength() > 0 ? this.Base.container.offsetHeight / this.getItemsLength() : this.Base.constructor.Html.cloneAndGetLineHeight()
  }, m.prototype.getItemsLength = function() {
    var e = this,
      t = 0;
    return Object.keys(this.items).forEach(function(n) {
      e.items[n].submenu || e.items[n].separator || t++
    }), t
    ...
    var n = this,
      ...
      h = c.find("li." + e + i + ">ul", this.Base.container, !0);
    u >= d.w ? (this.Base.container.style.right = "auto", this.Base.container.style.left = t[0] + 5 + "px") : (this.Base.container.style.left = "auto", this.Base.container.style.right = "15px"), l >= d.h ? (this.Base.container.style.bottom = "auto", this.Base.container.style.top = t[1] - 10 + "px") : (this.Base.container.style.top = "auto", this.Base.container.style.bottom = 0), c.removeClass(this.Base.container, e + s), h.length && (u < 2 * d.w ? this.submenu.last_left = "-" + d.w + "px" : this.submenu.last_left = this.submenu.left, h.forEach(function(e) {
      e.style.left = n.submenu.last_left
    }))
  }, m.prototype.openMenu = function(e, t) {
    this.positionContainer(e), this.Base.dispatchEvent({
      type: u.OPEN,
      pixel: e,
      coordinate: t
    })
  }, m.prototype.closeMenu = function() {
    c.addClass(this.Base.container, e + s), this.Base.dispatchEvent({
      type: u.CLOSE
    })
  }, m.prototype.getNextItemIndex = function() {
    return ++this.counter
  }, m.prototype.setListeners = function() {
    var e = this,
      t = this.map,
      n = t.getTargetElement(),
      i = function(i) {
        e.coordinate_clicked = t.getEventCoordinate(i), e.pixel_clicked = t.getEventPixel(i), e.Base.dispatchEvent({
          type: u.BEFOREOPEN,
          pixel: e.pixel_clicked,
          coordinate: e.coordinate_clicked
        }), e.Base.disabled || (i.stopPropagation(), i.preventDefault(), e.openMenu(e.pixel_clicked, e.coordinate_clicked), n.addEventListener("mousedown", {
          handleEvent: function(t) {
            e.closeMenu(), n.removeEventListener(t.type, this, !1)
          }
        }, !1))
      };
    n.addEventListener("contextmenu", i, !1), h.subscribe(u.ADD_MENU_ENTRY, function(t) {
      e.setItemListener(t.element, t.index)
    })
  }, m.prototype.setItemListener = function(e, t) {
    var n = this;
    e && "function" == typeof this.items[t].callback && ! function(i) {
      e.addEventListener("click", function(e) {
        e.preventDefault();
        var s = {
          coordinate: n.getCoordinateClicked(),
          data: n.items[t].data || null
        };
        n.closeMenu(), i.call(void 0, s, n.map)
      }, !1)
    }(this.items[t].callback)
  };
  var f = function(e) {
    return this.Base = e, this.Base.container = this.container = this.createContainer(), this
  };
  f.prototype.createContainer = function() {
    var n = document.createElement("ul");
    return n.className = [e + t, e + s, l].join(" "), n.style.width = parseInt(this.Base.options.width, 10) + "px", n
  }, f.prototype.createMenu = function() {
    var e = this.Base.options,
      t = [];
    return "items" in e ? t = e.default_items ? e.items.concat(p) : e.items : e.default_items && (t = p), 0 !== t.length && void t.forEach(this.addMenuEntry, this)
  }, f.prototype.addMenuEntry = function(n) {
    var s = this,
      o = this.Base.constructor.Internal,
      a = o.getNextItemIndex(),
      r = e + i;
    if (n.items && Array.isArray(n.items)) {
      n.classname = n.classname || "", c.contains(r, n.classname) || (n.classname += " " + r);
      var l = this.generateHtmlAndPublish(this.container, n, a),
        u = document.createElement("ul");
      u.className = e + t, u.style.left = o.submenu.last_left || o.submenu.left, u.style.width = this.Base.options.width + "px", l.appendChild(u), n.items.forEach(function(e) {
        s.generateHtmlAndPublish(u, e, o.getNextItemIndex(), !0)
      })
    } else this.generateHtmlAndPublish(this.container, n, a)
  }, f.prototype.generateHtmlAndPublish = function(t, i, s, a) {
    var r, l, d, p = !1,
      m = this.Base.constructor.Internal;
    return "string" == typeof i && "-" == i.trim() ? (r = '<li class="' + e + n + '"><hr></li>', l = c.createFragment(r), d = [].slice.call(l.childNodes, 0)[0], t.appendChild(l), p = !0) : (i.classname = i.classname || "", r = "<span>" + i.text + "</span>", l = c.createFragment(r), d = document.createElement("li"), i.icon && ("" === i.classname ? i.classname = e + o : i.classname.indexOf(e + o) === -1 && (i.classname += " " + e + o), d.setAttribute("style", "background-image:url(" + i.icon + ")")), d.id = "index" + s, d.className = i.classname, d.appendChild(l), t.appendChild(d)), m.items[s] = {
      id: s,
      submenu: a || 0,
      separator: p,
      callback: i.callback,
      data: i.data || null
    }, h.publish(u.ADD_MENU_ENTRY, {
      index: s,
      element: d
    }), d
  }, f.prototype.removeMenuEntry = function(e) {
    var t = c.find("#index" + e, this.container);
    t && this.container.removeChild(t), delete this.Base.constructor.Internal.items[e]
  }, f.prototype.cloneAndGetLineHeight = function() {
    var e = this.container.cloneNode(),
      t = c.createFragment("<span>Foo</span>"),
      n = c.createFragment("<span>Foo</span>"),
      i = document.createElement("li"),
      s = document.createElement("li");
    i.appendChild(t), s.appendChild(n), e.appendChild(i), e.appendChild(s), this.container.parentNode.appendChild(e);
    var o = e.offsetHeight / 2;
    return this.container.parentNode.removeChild(e), o
  };
  var y = function(e) {
    function t(n) {
      void 0 === n && (n = {}), c.assert("object" == typeof n, "@param `opt_options` should be object type!"), this.options = c.mergeOptions(d, n), this.disabled = !1, t.Internal = new m(this), t.Html = new f(this), e.call(this, {
        element: this.container
      })
    }
    return e && (t.__proto__ = e), t.prototype = Object.create(e && e.prototype), t.prototype.constructor = t, t.prototype.clear = function() {
      Object.keys(t.Internal.items).forEach(function(e) {
        t.Html.removeMenuEntry(e)
      })
    }, t.prototype.close = function() {
      t.Internal.closeMenu()
    }, t.prototype.enable = function() {
      this.disabled = !1
    }, t.prototype.disable = function() {
      this.disabled = !0
    }, t.prototype.getDefaultItems = function() {
      return p
    }, t.prototype.extend = function(e) {
      c.assert(Array.isArray(e), "@param `arr` should be an Array."), e.forEach(this.push, this)
    }, t.prototype.pop = function() {
      var e = this.container.lastChild;
      e && this.container.removeChild(e)
    }, t.prototype.push = function(e) {
      c.assert(c.isDefAndNotNull(e), "@param `item` must be informed."), t.Html.addMenuEntry(e, t.Internal.getNextItemIndex()), t.Internal.positionContainer(t.Internal.getPixelClicked())
    }, t.prototype.setMap = function(e) {
      ol.control.Control.prototype.setMap.call(this, e), t.Internal.init(e)
    }, t
  }(ol.control.Control);
  return y
});

//end of ol3-contextmenu.js
