...
var appConfigInfo = {
	...
	apiManURL : "http://tiotapi/",
	apiManVersion : "1.0.0",
	apiManKey : "Zk0yZjA5MFVtN2Z6ZHlkTkZvY2J6X1dLb2NFYTpidHRZdGdMU0RsSGZmT1RWRmRCa2FtRVR2VVFh",
	apimanUser : "admin",
	apimanPass : "admin",

	apiManGetAccessToken : "http://tiotapi/tiotAPIESBSubSystem/1.0.0/getAccessToken",
	apiManUsername : "admin",
	apiManPassword : "admin",
	apiManAuthorizationKey : "Zk0yZjA5MFVtN2Z6ZHlkTkZvY2J6X1dLb2NFYTpidHRZdGdMU0RsSGZmT1RWRmRCa2FtRVR2VVFh",
	apiManUrlForGecode : "http://tiotapi/t/tsf.com/tiotGIS/1.0.0",
	...
	mapserverURL : "http://tiotmaps/trinityMapserver/topp/wms",
	...
	url : "http://tiotmaps/dahod_geoserver_2_17_2/wfs",
	gwc : false,
	wfslayerurl : "http://tiotmaps/dahod_geoserver_2_17_2/wfs",
	...
	esrireverseGeocode : "https://tiotmaps/arcgis/rest/services/Agartala/Agartala_Address_Locator/GeocodeServer/reverseGeocode",
	esriGeocode: "https://tiotmaps/arcgis/rest/services/Agartala/Agartala_Address_Locator/GeocodeServer/findAddressCandidates",
	esriPlaceSearch:"https://tiotmaps/arcgis/rest/services/Agartala/Agartala_Address_Locator/GeocodeServer/suggest?searchExtent=",
	esriRoutingToken:"https://tiotmaps/arcgis/tokens/generateToken?username=trinity&password=tringis",
	esriRouting:"https://tiotmaps/arcgis/rest/services/Agartala/Agartala_Routing_Service/NAServer/Route/solve",
	esriClientId : "c3IdgLLqwxVtCu91",
	esriClientSecret : "3b6fa497594440dda121bf97182f95a4",
	GlobaloffLineMap:'\\tiotmaps\webapps\trinityAPI\v3.3\Cesium-1.83\Build\Cesium\Assets\Textures\NaturalEarthII',
	
	poi_img_url : "http://tiotmaps/trinityAPI/v2.12/poi",	
	// gwcurl : "https://caicoc.trinityiot.in/demomaps/cgi-bin/IGiS_Ent_service.exe?IEG_PROJECT=puducherry_ws",//http://demomaps.sgligis.com/cgi-bin/IGiS_Ent_service.exe?IEG_PROJECT=puducherry_ws,http://tiotapi/trinityMapserver/topp/wms
	// wmsurl : "https://caicoc.trinityiot.in/demomaps/cgi-bin/IGiS_Ent_service.exe?IEG_PROJECT=puducherry_ws",//http://demomaps.sgligis.com/cgi-bin/IGiS_Ent_service.exe?IEG_PROJECT=puducherry_ws,http://tiotapi/trinityMapserver/topp/wms
	// streetLayer : "osm",//topp:tasmania_state_boundaries
	// url : "http://tiotapi/trinityMapserver/topp/wms",
	...
	vehicleTrackZoom : 15,
 	...
 	trinitySatelliteurl : "http://tiotmaps/geoserver/wms/",//"
	trinitySatelliteLayer : "landuse:LU.Landuse",
 	trinitySatellitegwc : false,
	drawRestrictionURL : 'http://tiotmaps/bangalore/landmark_search/withInBoundary/',
	...
	{	
		...
		url:"http:/tiotgis.tsf.com/EGISAPIService/apis",
		project : "trinityGIS",
...
// mmi_tokenurl : window.location.protocol+'//'+window.location.hostname+"/api/security/oauth/token?grant_type=client_credentials&client_id=",
// mmi_basemap_url : window.location.protocol+'//'+window.location.hostname+"/getMap?service=WMS&request=GetWMSMap&version=1.1.1&layers=&format=image%2Fpng&transparent=true&datasetNme=",
// mmi_reversegeocode : window.location.protocol+'//'+window.location.hostname+"/advancedmaps/v2/",
// mmi_nearbyplaces : window.location.protocol+'//'+window.location.hostname+"/api/places/search/json?access_token=",
// mmiRoute : window.location.protocol+'//'+window.location.hostname+"/advancedmaps/v1/",
// mmi_search : window.location.protocol+'//'+window.location.hostname+"/api/places/search/json",
// baseUrl :window.location.protocol+'//'+window.location.hostname+'/getMap',
// wmsUrl :window.location.protocol+'//'+window.location.hostname+'/api/getMap',
...
function processConfig(config) {
  ...
  //https://hcsjointstack.trinityiot.in/EGISAPIService/apis/
...
var settings = {
	...
	"headers": {
	  ...
	  "Referer": "https://hcsjointstack.trinityiot.in/EGISClientApp/",
	  ...
	  "cookie": "Path=/; ai_user=o88zGX+zazJagdwjtZAZWU|2024-02-26T06:12:56.156Z; _sp_id.5c88=47adc9b7-bc23-4039-bfba-c11c9ff013c6.1708062467.26.1711436114.1711359855.fd20c52c-5ddf-45d5-ba04-c976d247012a.4a8e6e0b-69d1-4964-b658-6cc1b5a59ee6...0",
  ...
  try {
	$.ajax(settings).done(function (response) {
		...
		console.log(" :::::::::: SDK  processedConfig New :::::::::::: ",processedConfig);
		}
