...
(function () {
	...
	tmpl.Map.mapCreation = function (param) {
		...
		if (appConfigInfo.type == "none") {      
			...
			if (targetDiv == undefined) {
				...
				return response ={statusCode : 'TD_GISSDK_0x001', message :'Invalid Map targetDiv ID'};
			}
	...
	tmpl.Map.switchBaseMaps = function (param) {
		...
		try {
			if (mapobj === null || mapobj === undefined) {
				...
				return response = { statusCode: 'TD_GISSDK_0x001', message: 'Invalid Map Object' };
			}
			else {
			...
			if (id > 5) {
				...
				return response = { statusCode: 'TD_GISSDK_0x001', message: 'Invalid ID param' };
			}
			else {
	...
	tmpl.Control.zoomIn = function (param) {
		...
		try {
			if (mapObj === null || mapObj === undefined) {
				console.log('tmpl.Control.zoomIn : Not a Valid Map Object.');
				return response = { statusCode: 'TD_GISSDK_0x001', message: 'Invalid Map Object' };
			}
			else {
				console.log('tmpl.Control.zoomIn : A Valid Map Object.');
			}
		} catch (error) {
			if (error instanceof Error) {
				// Error code handling
				console.log("tmpl.Control.zoomIn : ", error.message);
			}
		}
	...
	tmpl.Control.zoomOut = function (param) {
		...
		try {
			if (mapObj === null || mapObj === undefined) {
				console.log('tmpl.Control.zoomOut : Not a Valid Map Object.');
				return response = { statusCode: 'TD_GISSDK_0x001', message: 'Invalid Map Object' };
			}
			else {
				console.log('tmpl.Control.zoomOut : A Valid Map Object.');
			}
		} catch (error) {
			if (error instanceof Error) {
				// Error code handling
				console.log("tmpl.Control.zoomOut : ", error.message);
			}
		}
	...
	tmpl.Control.addScale = function (param) {
		...
		try {
			if (mapObj === null || mapObj === undefined) {
				console.log('tmpl.Control.addScale : Not a Valid Map Object.');
				return response = { statusCode: 'TD_GISSDK_0x001', message: 'Invalid Map Object' };
			}
			else {
				console.log('tmpl.Control.addScale : A Valid Map Object.');
			}  
		} catch (error) {      
			if (error instanceof Error) {
				// Error code handling
				console.log("tmpl.Control.addScale : ", error.message);
			}
		}
		if (appConfigInfo.mapLib == 'ol7') {
	...
	tmpl.Control.addZoomToExtent = function (param) {
		...
		try {
			if (mapObj === null || mapObj === undefined) {
				console.log('tmpl.Control.addZoomToExtent : Not a Valid Map Object.');
				return response = { statusCode: 'TD_GISSDK_0x001', message: 'Invalid Map Object' };
			}
			else {
				console.log('tmpl.Control.addZoomToExtent : A Valid Map Object.');
			}
		} catch (error) {
			if (error instanceof Error) {
				// Error code handling
				console.log("tmpl.Control.addZoomToExtent : ", error.message);
			}
		}
		...
		if (appConfigInfo.mapLib == 'ol7') {
			...
			var bounds = L.latLngBounds([{ lat: appConfigInfo.bound1lat, lng: appConfigInfo.bound1lon }, { lat: appConfigInfo.bound2lat, lng: appConfigInfo.bound2lon }]);
	...
	tmpl.Control.addMousePostion = function (param) {
		...
		try {
			if (mapObj === null || mapObj === undefined) {
				console.log('tmpl.Control.addMousePostion : Not a Valid Map Object.');
				return response = { statusCode: 400, message: 'Invalid Map Object' };
			}
			else {
				console.log('tmpl.Control.addMousePostion : A Valid Map Object.');
			}
		} catch (error) {
			if (error instanceof Error) {
				console.log("tmpl.Control.addMousePostion : ", error.message);
			}
		}
		var targetDiv = param.target;
		if (appConfigInfo.mapLib == 'ol7') {
			...
			var mouseLatLng = L.DomUtil.create('div', 'mouse-latlng');
			mouseLatLng.style.position = 'absolute';
			mouseLatLng.style.bottom = '10px';
			mouseLatLng.style.left = '10px';
			mouseLatLng.style.zIndex = '400';
			document.getElementById(targetDiv).appendChild(mouseLatLng);

			mapObj.on('mousemove', function (e) {
				mouseLatLng.innerHTML = 'Latitude: ' + e.latlng.lat.toFixed(4) + '<br>Longitude: ' + e.latlng.lng.toFixed(4);
			});
		}
	}
	...
	tmpl.Control.addFullScreen = function (param) {
		...
		try {
			if (mapObj === null || mapObj === undefined) {
				console.log('tmpl.Control.addFullScreen : Not a Valid Map Object.');
				return response = { statusCode: 'TD_GISSDK_0x001', message: 'Invalid Map Object' };
			}
			else {
				console.log('tmpl.Control.addFullScreen : A Valid Map Object.');
			}
		} catch (error) {
			if (error instanceof Error) {
				// Error code handling
				console.log("tmpl.Control.addFullScreen : ", error.message);
			}
		}
		if (appConfigInfo.mapLib == 'ol7') {
			...
			mapObj.addControl(new L.Control.Fullscreen()); // Note full screen library also load before calling library.
	...
	tmpl.Overlay.create = function (param) {
		...
		if (mapObj === null || mapObj === undefined) {
			console.log('tmpl.Overlay.create  : Not a Valid Map Object.');
			return response = { statusCode: 'TD_GISSDK_0x001', message: 'Invalid Map Object' };
		}
		else {
			console.log('tmpl.Overlay.create  : A Valid Map Object.');
		}

		if (image_scale == undefined)
			image_scale = 1;
		if (getdata.length == 0) {
			return response = { statusCode: 'TD_GISSDK_0x001', message: 'Invalid features Object' };
		}
	...
	tmpl.Track.smoothMovement.prototype = {
		...
		drawAnimatedLine: function (startPt, endPt, steps, time) {
			...
			itsparent.track_ivlDraw = setInterval(function () {
				...
				console.log("newEndPt..", newEndPt, toltipTick, itsparent.feature.getProperties());
			...
			if (param.data.length == 1 || param.data.length == 0) {
				...
				if (param.data.length == 1 || param.data.length == 0) {
					...
					if (map === null || map === undefined) {
						console.log('tmpl.Trip.display : Not a Valid Map Object.');
						return response ={statusCode : 'TD_GISSDK_0x001', message :'Invalid Map Object'};
					}
					else {
						console.log('tmpl.Trip.display : A Valid Map Object.');
					}
...
tmpl.Map.getWMSMetaData = function (param) {
	try {
		...
		gmap.on('singleclick', function (evt) {
			...
			var i;
			for (i = 1; i <= ((layersCollection.a.length - 1)); i++) { //Loops through all layers excluding baselayer at index 0 and gets their URL
