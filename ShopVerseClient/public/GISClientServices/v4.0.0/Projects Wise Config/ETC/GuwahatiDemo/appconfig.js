...
var appConfigInfo = {
	...
	marathilayer:"",
	gwc : true,
	gwcurl : "http://tiotmaps/mpeh_geoserver_2.22/mpeh/wms",
	wmsurl : "http://tiotmaps/mpeh_geoserver_2.22/mpeh/wms",
	url : "http://tiotmaps/mpeh_geoserver_2.22/mpeh/wms",
	streetLayer : "MPEH",
...
mmi_tokenurl : "https://tiotgis/api/security/oauth/token?grant_type=client_credentials&client_id=",
mmi_basemap_url : "https://tiotops/getMap?service=WMS&request=GetWMSMap&version=1.1.1&layers=&format=image%2Fpng&transparent=true&datasetNme=",
mmi_reversegeocode : "https://tiotgis/advancedmaps/v2/",
mmi_nearbyplaces : "https://tiotgis/api/places/search/json?access_token=",
mmiRoute : "https://tiotgis/advancedmaps/v1/",
mmi_search : "https://tiotgis/api/places/search/json",
baseUrl :'https://tiotops/getMap',
wmsUrl :'https://tiotops/api/getMap',
...
mmi_layers : [
	...
	sglBaseMapLayer: 'road_centerline,river',
	sglLayers: [
	...
	sgl_baseMap:"https://demomaps.sgligis.com:8443/cgi-bin/IGiS_Ent_service.exe?IEG_PROJECT=gscl_basemap_ws",
	...
	sgl_reversegeocode:"http://10.200.9.143:1213/IGISRestAPI/Geocoder/GetAttributeValueFromLayer/landmarks/",
	sgl_geocode:"http://10.200.9.143:1213/IGISRestAPI/Geocoder/GetLocationsFromAttribute/landmarks/type/",
	sgl_transformwk:"http://10.200.9.143:1213/IGISRestAPI/Miscellaneous/TransformWKT",
	sgl_route:"http://10.200.9.143:1213/IGISRestAPI/Network/FindShortestPathMultiRoute?asfile=false",
	sgl_srid:"4326",
