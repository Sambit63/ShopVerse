...
var appConfigInfo = {
	...
	mapSDKURL: params+"/GISClientServices/v4.0.0/",
	// mapSDK3DURL: params+"/GISClientServices/v4.0.0/cesium/",
...
// CORE – REQUIRED FOR MAP CREATION
var trinityGIS_JS_CORE = [
	appConfigInfo.mapSDKURL + "trinityapi.Utils.js",
	appConfigInfo.mapSDKURL + "external/crypto-js.min.js",
	appConfigInfo.mapSDKURL + "ol7/ol.js",
	appConfigInfo.mapSDKURL + "external/jquery-3.7.1.min.js",
...
// OPTIONAL – LOAD LATER (NO MAP CREATION DEPENDENCY)
var trinityGIS_JS_OPTIONAL = [
  appConfigInfo.mapSDKURL + "external/turf.min.js",
  appConfigInfo.mapSDKURL + "external/html2canvas.min.js",
  appConfigInfo.mapSDKURL + "external/jspdf.umd.min.js",
  appConfigInfo.mapSDKURL + "c3-master/c3.js",
...
function processConfigdash(config) {
...
var vaultReadingURL = params + "/EGISAPIService/apis/readSDKVault"
        ...
        try {
            $.ajax(settings).done(function (response) {
                ...
                if (response && response.status == true) {
                    ...
                    const processedConfig = processConfigdash(sdkVaultDetails);
...
loadScripts(trinityGIS_JS_CORE, function () {
  console.log("CORE GIS scripts loaded (Map APIs available)");
  allScriptsLoaded();
//   setTimeout(function () {
//     console.log("Loading OPTIONAL GIS modules...");
//     loadScripts(trinityGIS_JS_OPTIONAL);
//   }, 1500);
});
