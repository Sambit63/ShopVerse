...
tmpl.Map.fetchVaultData = function (param) {
	var settings = {
		"url": "http://tiotvaultrd.trinitymobility.com:8200/v1/secret/Dev/Platform/Gis_config/Gis_SDK.json",
		"method": "GET",
		"timeout": 0,
		"headers": {
...
tmpl.Map.fetchVaultData1 = function (param) {
...
xhr.open("GET", "http://192.168.1.87:8200/v1/secret/Dev/Platform/Gis_config/Gis_SDK.json");
xhr.setRequestHeader("Content-Type", "application/json");
xhr.setRequestHeader("X-Vault-Token", "7335292d-02fd-7fb9-e6bd-e8937c527ec0");
xhr.setRequestHeader("Authorization", "Bearer 7335292d-02fd-7fb9-e6bd-e8937c527ec0");
...
tmpl.Map.pointWithinBoundary = function (param) {
	...
	var result;
	var settings = {
		"url": "http://192.168.1.54:8585/EGISAPIService/apis/getBoundaryConatins",
		"method": "POST",
		"timeout": 0,
		"headers": {
			"Content-Type": "application/json"
